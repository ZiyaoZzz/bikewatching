...
mapboxgl.accessToken = 'pk.eyJ1Ijoieml5YW96aG91IiwiYSI6ImNtN2JieHJ2azBkOTQybG9tMmw0cWI4ZWwifQ.ucrY9V_dc7pE_NMlZhe6WA';
...
function updateTrafficVisualization(stationData = stations) {
  ...
  const radiusScale = d3
    ...
    .style("--color", "color-mix(in oklch, var(--color-departures) calc(100% * var(--departure-ratio)), var(--color-arrivals))") // Apply color mix
    .attr("fill", "var(--color)") 
    .each(function (d) {
